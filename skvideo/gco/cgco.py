...
_CGCO_LIB_PATH = "/home/strongn/develop/video-research/pyGCO-pkg"
# print("Looking for 'libcgco' here:", _CGCO_LIB_PATH)
LIB_NAME = 'libcgco'

LIST_LIBGCO = glob.glob(os.path.join(_CGCO_LIB_PATH, LIB_NAME + '.*'))
assert len(LIST_LIBGCO) > 0, 'nothing found: %s. Be sure to run "make" in ../pyGCO-pkg/' % repr(LIST_LIBGCO)
